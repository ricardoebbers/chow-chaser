...
config :chow_chaser, ChowChaserWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: ChowChaserWeb.ErrorHTML, json: ChowChaserWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: ChowChaser.PubSub,
  live_view: [signing_salt: "OE0Eh7/4"]
...
config :chow_chaser, ChowChaser.Mailer, adapter: Swoosh.Adapters.Local
