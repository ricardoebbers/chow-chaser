defmodule ChowChaserWeb.Router do
  use ChowChaserWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ChowChaserWeb.Layouts, :root}
  ...
  # scope "/api", ChowChaserWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:chow_chaser, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ChowChaserWeb.Telemetry
